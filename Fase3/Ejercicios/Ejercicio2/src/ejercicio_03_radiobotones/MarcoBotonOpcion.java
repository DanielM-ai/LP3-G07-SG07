package ejercicio_03_radiobotones;
...
public class MarcoBotonOpcion extends JFrame
{
    ...
    {
        super("Mansilla-Márquez: Prueba de RadioButton");
    ...
    private class ManejadorBotonOpcion implements ItemListener
    {
        ...
        {
            // La lógica clave de este manejador es que solo la opción SELECCIONADA
            // ejecutará la acción de cambio de fuente, gracias a ButtonGroup.
